...
$(document).ready(function() {
    $("#menu-audifonos-prueba").click(function() {
        $("#nav-tab-1").trigger('click');
    });
    $("#menu-audifonos-garantia").click(function() {
        $("#nav-tab-2").trigger('click');
    });
    $("#menu-audifonos-descuento").click(function() {
        $("#nav-tab-3").trigger('click');
    });
